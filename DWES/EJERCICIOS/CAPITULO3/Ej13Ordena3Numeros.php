        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {   //si he pulsado boton del form
          ...
          if (!is_numeric($numero1 . $numero2 . $numero3 )){
            ...
            if ($numero1 >= $numero2) {
              if ($numero1 >= $numero3) {
                if ($numero2 >= $numero3){
                  echo "Los numeros ordenados de mayor a menor son: " . $numero1 . ", " . $numero2 . ", " . $numero3;
                } else {
                  echo "Los numeros ordenados de mayor a menor son: " . $numero1 . ", " . $numero3 . ", " . $numero2;
                }
              } else {
                  echo "Los numeros ordenados de mayor a menor son: " . $numero3 . ", " . $numero1 . ", " . $numero2;
                } 
            }else if ($numero2 >= $numero3) {
              if ($numero3 >= $numero1) {
                echo "Los numeros ordenados de mayor a menor son: " . $numero2 . ", " . $numero3 . ", " . $numero1;
              } else {
                echo "Los numeros ordenados de mayor a menor son: " . $numero2 . ", " . $numero1 . ", " . $numero3;
              }
            }else {
              echo "Los numeros ordenados de mayor a menor son: " . $numero3 . ", " . $numero2 . ", " . $numero1;
            } 
          }
        }
      ?>   
